...
| Public lore tab "Hồ Sơ Lưu Trữ" (owner Q1–Q7 answered 2026-09-26) | **Spec written, waiting for owner review**: [`superpowers/specs/2026-09-26-public-lore-tab-design.md`](./superpowers/specs/2026-09-26-public-lore-tab-design.md). Next: owner approves → `writing-plans`; visual step uses `huashu-design` + the owner's taste-skill pack (`.agents/skills/*taste*`, installed 2026-09-26 — needs a new session to appear in `/`) |

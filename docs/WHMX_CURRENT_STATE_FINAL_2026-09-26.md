...
| Public lore tab "Hồ Sơ Lưu Trữ" (owner Q1–Q7 answered 2026-09-26) | **Spec approved 2026-09-26** ([`superpowers/specs/2026-09-26-public-lore-tab-design.md`](./superpowers/specs/2026-09-26-public-lore-tab-design.md)); **plan written, waiting for owner review + execution method**: [`superpowers/plans/2026-09-26-public-lore-tab.md`](./superpowers/plans/2026-09-26-public-lore-tab.md) (6 tasks; Task 1 data.json diff and Task 4 design pick are owner gates); visual step uses `huashu-design` + the owner's taste-skill pack (`.agents/skills/*taste*`, installed 2026-09-26 — needs a new session to appear in `/`) |
